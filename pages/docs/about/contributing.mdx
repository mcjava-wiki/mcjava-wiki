...
2. Select `URL` and enter `https://github.com/Kas-tle/mcjava-wiki`
...
[Firefox Developer Edition](https://duckduckgo.com "The best browser! (and this hover tip is optional)").
