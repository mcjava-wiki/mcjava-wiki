...
Contributions are also welcome. Please create a pull request [here](https://github.com/Kas-tle/mcjava-wiki/pulls). Refer to the contributing section for a more detailed guide.
